// The ticket booking system of Cinemax theater has to be implemented using C++ program. There
// are 10 rows and 7 seats in each row. Doubly circular linked list has to be maintained to keep track
